...
class MainWindow:
    def __init__(self):
        ...
        # self.loginWindow.logButton.clicked.connect(self.student)
    ...
    def student_exit(self):
        if self.studentWindow:
            if QtWidgets.QMessageBox.information(self.studentWindow, "Warning", "Are you sure want to exit?",
                                                 QtWidgets.QMessageBox.Cancel | QtWidgets.QMessageBox.Yes) == QtWidgets.QMessageBox.Yes:
                sys.exit(0)

    def login(self):
        if self.studentWindow:
            if QtWidgets.QMessageBox.information(self.studentWindow, "Warning", "Are you sure want to Log out?",
                                                 QtWidgets.QMessageBox.Cancel | QtWidgets.QMessageBox.Yes) == QtWidgets.QMessageBox.Yes:
